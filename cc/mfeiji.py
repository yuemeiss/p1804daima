...
ufo = pygame.image.load('./photo/image/enemy3.png').convert_alpha()
background = pygame.image.load('./photo/image/img_bg_level_2.jpg').convert_alpha()
gameover_image = pygame.image.load('./photo/image/img_bg_logo.jpg').convert_alpha()
plane_image = pygame.image.load('./images/hero1.png').convert_alpha()
bullet_image = pygame.image.load('./images/bullet.png').convert_alpha()
enemy_image = pygame.image.load('./images/enemy-1.gif').convert_alpha()
logo = pygame.image.load('./images/startone.png').convert_alpha()
bomb_num = pygame.image.load('./images/bomb-1.gif').convert_alpha()
bomb_image = pygame.image.load('./images/bomb.png').convert_alpha()
loading = []
loading.append(pygame.image.load('./images/game_loading1.png').convert_alpha())
loading.append(pygame.image.load('./images/game_loading2.png').convert_alpha())
loading.append(pygame.image.load('./images/game_loading3.png').convert_alpha())
enemydown=[]
enemydown.append(pygame.image.load('./images/enemy0_down1.png').convert_alpha())
enemydown.append(pygame.image.load('./images/enemy0_down2.png').convert_alpha())
enemydown.append(pygame.image.load('./images/enemy0_down3.png').convert_alpha())
enemydown.append(pygame.image.load('./images/enemy0_down4.png').convert_alpha())
boom = []
boom.append(pygame.image.load('./images/hero_blowup_n1.png').convert_alpha())
boom.append(pygame.image.load('./images/hero_blowup_n2.png').convert_alpha())
boom.append(pygame.image.load('./images/hero_blowup_n3.png').convert_alpha())
boom.append(pygame.image.load('./images/hero_blowup_n4.png').convert_alpha())
boom.append(pygame.image.load('./images/hero_blowup_n4.png').convert_alpha())
backmusic=pygame.mixer.Sound('./images/music.ogg')
buttonmusic = pygame.mixer.Sound('./images/bonus.life.wav')
bulletmusic = pygame.mixer.Sound('./images/shoot.wav')
enemydownmusic = pygame.mixer.Sound('./images/kill.wav')
gameovermusic = pygame.mixer.Sound('./images/gameOver.wav')
getbombmusic = pygame.mixer.Sound('./images/player.move.wav')
usebombmusic = pygame.mixer.Sound('./images/brickErase.wav')
...
class Button(object):
    def __init__(self, upimage, downimage, position):
        self.image_up = pygame.image.load('./images/button_nor.png').convert_alpha()
        self.image_down = pygame.image.load('./images/button_p.png').convert_alpha()
...
class Enemy(object):
    def restart(self, score):
        ...
        self.speed = randint(min(int(200+score/80),400),min(int(400+score/40),700))
        self.active = True
        self.count = -1
    def __init__(self,):
        self.restart(0)
...
def run():
    sound = True
    gameStart = Button('./images/game_resume_nor.png','./images/game_resume_pressed.png',(SCREEN_SIZE[0]/2,SCREEN_SIZE[1]*8/12))
    gameOver = Button('./images/quit_nor.png','./images/quit_sel.png',(SCREEN_SIZE[0]/2,SCREEN_SIZE[1]*11/12))
    gameAgain = Button('./images/restar_nor.png','./images/restart_sel.png',(SCREEN_SIZE[0]/2,SCREEN_SIZE[1]*10/12))
    gameContinue = Button('./images/resume_nor.png','./images/resume_sel.png',(SCREEN_SIZE[0]/2,SCREEN_SIZE[1]*9/12))
    loadingCount = 0
        ...
        if gamePause:
           ...
           # interval_b2 -= 1
            ...
            if interval_e < 0:
                ...
                interval_e = randint(max(0,int(30-SCORE/250)),max(7,int(50-SCORE/700)))
